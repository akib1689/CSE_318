...
public class BacktrackSolver {
    ...
    public BacktrackSolver(VariableHeuristic heuristic) {
    ...
    public void solve (CSP csp){
        ...
        if (ret_val) {
            ...
            System.out.println("BacktrackSolver , " + variableHeuristic + " , " + nodeCount + " , " + backtrack + " , " + sb);
...
//        List<Integer> domain = variable.domain();
    ...
    private void processVariable(CSP csp, Variable variable, HashSet<Variable> set){
        for (int i = 0; i < csp.size(); i++) {
            Variable row_variable = csp.getVariable(variable.x(), i);
